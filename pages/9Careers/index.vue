<template>
  <div>
    <div id="harry_potter_bgc" class="harry_potter_bgc">
      <div id="banner_block" class="banner_block">
        <div class="container-xxl">
          <div class="row">
            <div class="col-12">
              <div id="banner_text" class="banner_text">
                <img src="~assets/images/top_deco.svg" alt="" />
                <div class="hash_tag">#RecruitPeopleNotPaper</div>
                <div class="title">
                  魔法學院裡，各學院有著不同的超能力；<br />
                  透過三款科學小遊戲，看看自己屬於哪個學院吧！
                </div>
                <div class="sub_title">
                  依據「職業類別」，完成分類帽客製的遊戲組合，回填簡易問券，<br
                    class="d-sm-block d-none"
                  />
                  即可得到Insula分析報告並分發進入魔法學院唷！
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-12 col-sm-6 d-block d-lg-none mx-auto">
              <div class="dropdown_section hp">
                ...
                >
                  ...
                  <option value="5">資訊研發（軟體／硬體／開發／設備）</option>
          ...
          <div class="row">
            <div class="col-12">
              <div id="top_section" class="top_section">
                <div>即日起至2022年2月底，限時免費測驗中！</div>
                <div>快來看看你是屬於哪個魔法學院</div>
                <div class="d-flex align-items-center" style="min-height: 43px">
                  <span class="material-icons"> arrow_forward </span>
                  <a
                    class="campaing_detail"
                    href="javascript:;"
                    @click="campaingDetail()"
                    >活動詳細說明</a
                  >
                </div>
              </div>
            ...
            <div class="col-12">
              <div style="position: relative;">
                <img
                    class="cloud_right"
                    style=""
                    src="~assets/images/img_cloud_02.png"
                  />
              </div>
            </div>
          </div>
            ...
            <div class="col-12" >
              <div style="position: relative;">
                <img
                    class="cloud_left"
                    style=""
                    src="~assets/images/img_cloud_01.png"
                  />
              </div>
            </div>
          </div>
            ...
            >
              <div class="text_box" style="transition-delay: 0.75s">
                ...
                <div class="sub_title">
                  ...
                  >，全面更新分類帽技能！
                  <span style="font-weight: bold">Insula</span
                  >是一系列測量認知能力與特質傾向的遊戲評測。職場上所需的核心能力難於面試評估，透過<span
                    style="font-weight: bold"
                    >Insula</span
                  >遊戲評測，提供科學實證的數據分析，評估你的優劣勢，挖掘潛在能力，將合適的人放在合適的工作職位。
                </div>
                <a
                  class="video_link"
    ...
    <div id="harry_potter" class="gamebase_flow_block harry_potter">
      <div class="container-xxl">
                ...
                <div class="row">
                  ...
                  >
                    <img
                      ...
                      src="~assets/images/hp_number-1.png"
                    />
                  </div>
                ...
                <div class="row">
                  ...
                  >
                    <img
                      ...
                      src="~assets/images/hp_number-2.png"
                    />
                  </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  >
                    <img
                      class="img_rwd my-xl-4 my-3"
                      src="~assets/images/hp_number-3.png"
                    />
                  </div>
                  <div class="col-sm-5 d-flex align-items-center">
                    <div>
                      <div class="card_title">
                        得到魔法學院的分類通知，以及魔法力測驗報告。<br
                          class="d-lg-block d-none"
                        />拜訪優聘FB抽更多魔法裝備
                      </div>
                      <div class="card_sub_title">
        ...
        <div id="btn_section" class="btn_section">
          ...
          <div class="my-4">
            <img src="~assets/images/divider_dimonds.png" />
          </div>
            ...
            <div class="accordion accordion-flush">
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    <div>
                      為讓魔法新鮮人／現職魔法師們更了解自己的魔法力，針對人力銀行的職業類別列出職業核心能力的受測組合，請選擇你的「職業類別」來測試職涯中的關鍵能力！<br />
                      <br />＊ 2022年3月恢復收費 NT$800元／一份 
          ...
          <div class="swiper-slide">
            <div class="mg_box mg1">
              <div class="container-xxl h-100">
                <div class="row h-100">
                  <div class="col-sm-5 offset-sm-6 col-12 p-relative">
                    <div class="text_box">
                      <div class="sub_title">
        ...
        <div class="row h-100">
          <div class="offset-sm-1 col-sm-5 col-12 p-relative">
            <div class="sub_title">
              ...
              <div class="text">
                為提供每位魔法實習生更好的學習發展，學院開發一款衡量特質與傾向的測驗，歡迎大家來挑戰！
              </div>
              <div class="arrow-container">
                <span class="material-icons arrow_animation"
                  >arrow_forward</span
                >
                <a href="javascript:;" @click="gotoGames()">挑戰泡泡糖</a>
              </div>
...
export default {
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          property: 'og:image',
          content:
            'https://resource.talfin.in/image/insula-web/insula_link_preview_9career_hp.png',
        },
      ],
    }
  },
  mounted() {
    ...
    this.$store.commit('theme/setTheme', 'hp')
  },
  beforeDestroy() {
  ...
  methods: {
    ...
    initBannerAnimate() {
      document.getElementById('harry_potter_bgc').classList.add('animate')
    ...
    scrolling() {
      ...
      // console.log(document.getElementById("harry_potter_bgc").offsetTop)
    ...
    gotoGames(type) {
      switch (Number(type)) {
        case 1:
          window.open(
            'https://insula.pse.is/HP_HR',
            '_blank'
          )
          break
        case 2:
          window.open(
            'https://insula.pse.is/HP_PM',
            '_blank'
          )
          break
        case 3:
          window.open(
            'https://insula.pse.is/HP_TR',
            '_blank'
          )
          break
        case 4:
          window.open(
            'https://insula.pse.is/HP_FI',
            '_blank'
          )
          break
        case 5:
          window.open(
            'https://insula.pse.is/HP_RD',
            '_blank'
          )
          break
        case 6:
          window.open(
            'https://insula.pse.is/HP_SE',
            '_blank'
          )
          break
        case 7:
          window.open(
            'https://insula.pse.is/HP_DE',
            '_blank'
          )
          break
        case 8:
          window.open(
            'https://insula.pse.is/HP_ED',
            '_blank'
          )
          break
        case 9:
          window.open(
            'https://insula.pse.is/HP_OT',
            '_blank'
          )
          break
