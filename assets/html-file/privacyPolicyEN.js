...
<ul>
  ...
  <li>
    <p>
      ...
      refers to Talfin Information Technology Ltd., 6th Floor-2, No. 179,
      Fuhuiyuan Road, Xitun District, Taichung City.
    </p>
  ...
  <li>
    <p>
      <strong>Website</strong> refers to Insula, accessible from
      <a
...
<ul>
  <li>
    <strong>Directly from You</strong>. For example, from the forms You complete
  ...
  <li>
    <strong>Automatically from You</strong>. For example, through cookies We or
...
<p>
  ...
  for valuable consideration. This means that We may have received some kind of
...
<ul>
  <li>
    <p>By email: marketing@talfin.ai</p>
  </li>
  <li>
    <p>
  ...
  <li>
    <p>
      By mail: 6th Floor-2, No. 179, Fuhuiyuan Road, Xitun District, Taichung
      City
    </p>
  </li>
</ul>
